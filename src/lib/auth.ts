...
/**
 * Extracts the raw Clerk session token from the request cookie.
 * This is the JWT that gets forwarded to the API as Authorization: Bearer.
...
/**
 * Fetches the WCS user profile from the API using the Clerk session JWT.
